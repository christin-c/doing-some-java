...
public class Main {
    ...
    public static void serializeUser() throws IOException {
        ...
        System.out.println("object user saved with id " + serialVersionUID);
    }

    public static void deserializeUserfile() throws IOException, ClassNotFoundException {
        User user2;
        FileInputStream fileIn = new FileInputStream("//Users//christin//IdeaProjects//Some-Java//UserInfo.ser");
